    ...
    $.ajax({
        ...
        success: function (data) {
            paymentFormJquery.append(
                "<input type ='hidden' name='ipinfo' value=''>"
            );
                        ...
                        if (mobileAndTabletCheck()) {
                            if (
                                ...
                                if (
                                    ...
                                    paymentForm.elements["payType"].value =
                                        "DC";
                                }
                                $("#" + formId).attr(
                                    "action",
...
function deleteToken() {
    ...
    if (
        (deleteForm.payToken.value != "" &&
            deleteForm.payToken.value != null) ||
        ...
        $.post(
            ...
            function (data) {
                ...
                window.top.location.href =
                    "/pg_was/new/sampleMerchant.do?" + param;
            }
        );
    } else {
        return;
